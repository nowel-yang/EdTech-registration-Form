    ...
    */
    ...
    public function init() {
        ...
        $defaults = array(
                    ...
                    'test_mode_message' => 'The Workshop Registeration  System is currently undergoing maintenance. Please check back later.',
                    'volunteer_page_id' => 0,
                    ...
                    'login_required_message' => 'You must be logged in to a valid account to view and register for workshops.',
...
This is to confirm that you have registered for the following workshop:
Event: {sheet_title} 
Date: {date}
...
$remind_template = 
"Dear {firstname} {lastname},
This is to remind you that you have registered for the following workshop:
Event: {sheet_title} 
Date: {date}
Start Time: {start_time}
End Time: {end_time}
...
$clear_template = 
"Dear {firstname} {lastname},
This is to confirm that you have  unregistered from the following workshop:
Event: {sheet_title} 
Presenter: {task_title}
Date: {date}
Start Time: {start_time}
End Time: {end_time}
{details_text}: {item_details}
...
";
        $defaults = array(
                    ...
                    'clear_email_subject' => 'You have been unregistered.',
                    'clear_email_template' => $clear_template,
                    'reminder_email_subject' => 'Workshop Reminder',
